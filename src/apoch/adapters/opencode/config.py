...
class OpenCodeConfig:
    ...
    def merge(
        ...
        apoch_command: list[str] | None = None,
    ) -> dict[str, Any]:
        ...
        Args:
            current: Current config dict.
            apoch_command: Resolved command to launch the Apoch CLI.
                           Defaults to ``["apoch", "mcp", "serve"]``.
        """
        if apoch_command is None:
            apoch_command = ["apoch"]
